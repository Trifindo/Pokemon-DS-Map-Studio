 ...
 * @author Trifindo
 */
public class NsbtxColorFormatAddSelector extends javax.swing.JDialog {
    ...
    /**
     * Creates new form NsbtxColorFormatAddSelector
     */
    public NsbtxColorFormatAddSelector(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(NsbtxColorFormatAddSelector.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                NsbtxColorFormatAddSelector dialog = new NsbtxColorFormatAddSelector(new javax.swing.JFrame(), true);
