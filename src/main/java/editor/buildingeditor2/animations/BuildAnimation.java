 ...
 * @author Trifindo
 */
public class BuildAnimation implements NamedFile {
    ...
    public BuildAnimation(byte[] data, int index) {
        this.data = data;
    ...
    public BuildAnimation(String path, int index) throws IOException, Exception {
