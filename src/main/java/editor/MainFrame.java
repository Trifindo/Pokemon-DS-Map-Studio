    ...
    private void initComponents() {
        ...
        //======== jmMainMenu ========
        {
            ...
            //======== jmFile ========
            {
                ...
                jmiNewMap.addActionListener(e -> jmiNewMapActionPerformed());
        ...
        //======== jspMainWindow ========
        {
            jspMainWindow.setResizeWeight(0.7);
                    ...
                    jpZLayout.setHorizontalGroup(
                            jpZLayout.createParallelGroup()
                                    .addGroup(jpZLayout.createSequentialGroup()
                                            .addComponent(heightSelector, GroupLayout.PREFERRED_SIZE, 0, GroupLayout.PREFERRED_SIZE)
                                            .addGap(0, 0, Short.MAX_VALUE))
                    );
                        ...
                        //======== jpHeightMapAlpha ========
                        {
                            ...
                            jpHeightMapAlphaLayout.setHorizontalGroup(
                                    jpHeightMapAlphaLayout.createParallelGroup()
                                            .addComponent(jsHeightMapAlpha, GroupLayout.DEFAULT_SIZE, 408, Short.MAX_VALUE)
                            );
