 ...
 * @author Trifindo
 */
public class BacksoundDisplay extends javax.swing.JPanel {
    ...
    /**
     * Creates new form BacksoundDisplay
     */
    ...
    private void formMouseDragged(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_formMouseDragged
        if (backsoundHandler.getSoundplates().size() > 0) {
            if (dragging && isCursorInsiePanel(evt)) {
                Soundplate p = backsoundHandler.getSelectedSoundplate();
                int deltaX = (evt.getX() - lastX) / TILE_SIZE;
                int deltaY = (evt.getY() - lastY) / TILE_SIZE;
                switch (partSelected) {
                    case CENTER:
    ...
    public boolean isCursorInsiePanel(java.awt.event.MouseEvent evt) {
        int x = evt.getX();
        int y = evt.getY();
