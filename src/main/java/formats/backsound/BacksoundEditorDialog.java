...
public class BacksoundEditorDialog extends JDialog {
    ...
    private void initComponents() {
        ...
        //======== panel2 ========
        {
            ...
            jbImport.setText("Import BGS");
            jbImport.addActionListener(e -> jbImportActionPerformed(e));
            panel2.add(jbImport, "cell 0 0");

            //---- jbExport ----
            jbExport.setIcon(new ImageIcon(getClass().getResource("/icons/ExportIcon.png")));
            jbExport.setText("Export BGS");
            jbExport.addActionListener(e -> jbExportActionPerformed(e));
            panel2.add(jbExport, "cell 1 0");

            //---- label1 ----
            label1.setText("BGS files are saved automatically when pressing the save map button from the main window");
            label1.setIcon(new ImageIcon(getClass().getResource("/icons/informationIcon.png")));
            panel2.add(label1, "cell 3 0");
        }
        contentPane.add(panel2, "cell 0 0 2 1");

        //---- backsoundDisplay ----
        backsoundDisplay.setBorder(new LineBorder(new Color(102, 102, 102)));
        contentPane.add(backsoundDisplay, "cell 0 1 1 3");
        ...
        contentPane.add(jPanel1, "cell 1 1");
        ...
        contentPane.add(jPanel2, "cell 1 2");
        pack();
