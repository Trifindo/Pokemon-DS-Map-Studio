...
public class NsbtxPanel extends JPanel {
    ...
    private void initComponents() {
        ...
        ((GridBagLayout)getLayout()).rowHeights = new int[] {165, 160, 0};
        ...
        //======== jPanel1 ========
        {
            ...
            ((GridBagLayout)jPanel1.getLayout()).columnWidths = new int[] {160, 0};
        ...
        //======== jPanel2 ========
        {
            ...
            ((GridBagLayout)jPanel2.getLayout()).columnWidths = new int[] {160, 0};
        ...
        //======== jPanel4 ========
        {
            ...
            ((GridBagLayout)jPanel4.getLayout()).rowHeights = new int[] {160, 0};
            ((GridBagLayout)jPanel4.getLayout()).columnWeights = new double[] {1.0, 1.0E-4};
            ((GridBagLayout)jPanel4.getLayout()).rowWeights = new double[] {0.0, 1.0E-4};
